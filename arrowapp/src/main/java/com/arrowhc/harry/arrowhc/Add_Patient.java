    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dsppiner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
              //  String docy= (String) parent.getItemAtPosition(position);
                ...
                Toast.makeText(Add_Patient.this, docName, Toast.LENGTH_SHORT).show();
            }
        ...
        nsppiner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Add_Patient.this, nurseName, Toast.LENGTH_SHORT).show();
            }
         ...
         departs.setOnItemClickListener(new AdapterView.OnItemClickListener() {
             ...
             public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                 ...
                 Toast.makeText(Add_Patient.this,departMent, Toast.LENGTH_SHORT).show();
             }
         });
           ...
           roomnos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
               ...
               public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                   ...
                   Toast.makeText(Add_Patient.this,roomNo, Toast.LENGTH_SHORT).show();
               }
           });
                 ...
                 public void onResponse(JSONArray response) {
                     ...
                     try {
                         for (int i = 0; i <response.length(); i++) {
                           ...
                           //  Toast.makeText(Add_Patient.this, proname, Toast.LENGTH_SHORT).show();
                              if(proname.equalsIgnoreCase("nurse"))
                              {
                                //  Toast.makeText(Add_Patient.this,"enet into nurses", Toast.LENGTH_SHORT).show();
                                 ...
                                 // Toast.makeText(Add_Patient.this,"data in heap"+ da, Toast.LENGTH_SHORT).show();

                              }
                             else if(proname.equalsIgnoreCase("doctor"))
                              {
                                //  Toast.makeText(Add_Patient.this, "Enter into doctors", Toast.LENGTH_SHORT).show();
                                ...
                                contactd.put("d_data",docid+","+doctor_name+","+dusername);
                                 ...
                                 // Toast.makeText(Add_Patient.this, "doctor heap"+da, Toast.LENGTH_SHORT).show();

                              }

                         }
                        // Toast.makeText(Add_Patient.this, "nurse list"+aarayListN.size(), Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(Add_Patient.this, "docotr data list"+doctordata.size(), Toast.LENGTH_SHORT).show();
